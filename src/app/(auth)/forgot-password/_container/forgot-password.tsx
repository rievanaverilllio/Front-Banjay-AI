...
export default function ForgotPassword() {
	...
	return (
		<div className="min-h-screen w-full flex relative bg-[#FAFAF5]">
			...
			<Link
				href="/dashboard"
				className="absolute top-6 left-6 z-20 flex items-center px-4 py-2 border border-gray-300 text-gray-700 rounded-full bg-white hover:bg-gray-100 hover:text-black transition font-medium text-sm shadow"
			>
				<svg
			...
			>
				...
				<motion.h2
					variants={fadeInFromBottom}
					className="text-3xl sm:text-4xl font-extrabold text-black mb-2 flex items-center"
				>
					Forgot password
